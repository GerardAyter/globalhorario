...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'tenant-settings', name: 'tenant-settings', component: () => import('../views/TenantSettingsView.vue'), meta: { minRole: 'superadmin' } },
      { path: 'tenants',      name: 'tenants',      component: () => import('../views/TenantsView.vue'),      meta: { minRole: 'founder'    } },
      { path: 'platform-settings', name: 'platform-settings', component: () => import('../views/PlatformSettingsView.vue'), meta: { minRole: 'founder' } },
    ],
  },
