...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'time-entries', name: 'time-entries', component: () => import('../views/PlaceholderView.vue') },
      { path: 'shifts',       name: 'shifts',       component: () => import('../views/PlaceholderView.vue') },
      { path: 'absences',     name: 'absences',     component: () => import('../views/PlaceholderView.vue') },
      { path: 'payrolls',     name: 'payrolls',     component: () => import('../views/PlaceholderView.vue') },
